...
module boothmul_registered ( CLK, LD, RST, A, B, P );
  ...
  wire   n138, n187, n188, n189, n190, n191, n192, n193, n194, n195, n196,
         ...
         n302, n303, n304, n305, n306, DP_OP_72J31_124_9845_n18,
         DP_OP_72J31_124_9845_n17, DP_OP_72J31_124_9845_n16,
         DP_OP_72J31_124_9845_n4, DP_OP_71J31_123_5612_n19,
         DP_OP_71J31_123_5612_n18, DP_OP_71J31_123_5612_n17,
         DP_OP_71J31_123_5612_n4, DP_OP_70J31_122_5612_n19,
         DP_OP_70J31_122_5612_n18, DP_OP_70J31_122_5612_n17,
         DP_OP_70J31_122_5612_n4, n330, n331, n332, n333, n334, n335, n336,
  ...
  AOI222_X1 U218 ( .A1(n191), .A2(
        ...
        DP_OP_72J31_124_9845_n18), .C1(n246), .C2(P[15]), .ZN(n188) );
  AOI222_X1 U221 ( .A1(n191), .A2(
        mul_final_add_sum_gen_carry_select_int_3_S1[2]), .B1(n192), .B2(
        DP_OP_72J31_124_9845_n17), .C1(n246), .C2(P[14]), .ZN(n189) );
  AOI222_X1 U223 ( .A1(n191), .A2(
        mul_final_add_sum_gen_carry_select_int_3_S1[1]), .B1(n192), .B2(
        DP_OP_72J31_124_9845_n16), .C1(n246), .C2(P[13]), .ZN(n190) );
  AOI22_X1 U226 ( .A1(n192), .A2(DP_OP_72J31_124_9845_n4), .B1(n246), .B2(
        P[12]), .ZN(n193) );
  OAI21_X1 U227 ( .B1(DP_OP_72J31_124_9845_n4), .B2(n194), .A(n193), .ZN(n278)
         );
  ...
  AOI222_X1 U231 ( .A1(n246), .A2(P[11]), .B1(n198), .B2(
        ...
        DP_OP_71J31_123_5612_n19), .ZN(n196) );
  AOI222_X1 U233 ( .A1(n246), .A2(P[10]), .B1(n198), .B2(
        mul_final_add_sum_gen_carry_select_int_2_S1[2]), .C1(n200), .C2(
        DP_OP_71J31_123_5612_n18), .ZN(n197) );
  AOI222_X1 U235 ( .A1(n246), .A2(P[9]), .B1(n198), .B2(
        mul_final_add_sum_gen_carry_select_int_2_S1[1]), .C1(n200), .C2(
        DP_OP_71J31_123_5612_n17), .ZN(n199) );
  AOI22_X1 U237 ( .A1(n246), .A2(P[8]), .B1(n200), .B2(DP_OP_71J31_123_5612_n4), .ZN(n201) );
  OAI21_X1 U238 ( .B1(DP_OP_71J31_123_5612_n4), .B2(n202), .A(n201), .ZN(n282)
         );
  ...
  AOI222_X1 U242 ( .A1(n246), .A2(P[7]), .B1(n206), .B2(
        ...
        DP_OP_70J31_122_5612_n19), .ZN(n204) );
  AOI222_X1 U244 ( .A1(n246), .A2(P[6]), .B1(n206), .B2(
        mul_final_add_sum_gen_carry_select_int_1_S1[2]), .C1(n208), .C2(
        DP_OP_70J31_122_5612_n18), .ZN(n205) );
  AOI222_X1 U246 ( .A1(n246), .A2(P[5]), .B1(n206), .B2(
        mul_final_add_sum_gen_carry_select_int_1_S1[1]), .C1(n208), .C2(
        DP_OP_70J31_122_5612_n17), .ZN(n207) );
  AOI22_X1 U248 ( .A1(n246), .A2(P[4]), .B1(n208), .B2(DP_OP_70J31_122_5612_n4), .ZN(n209) );
  OAI21_X1 U249 ( .B1(DP_OP_70J31_122_5612_n4), .B2(n210), .A(n209), .ZN(n286)
         );
  ...
  INV_X1 U360 ( .A(n348), .ZN(DP_OP_70J31_122_5612_n17) );
  INV_X1 U361 ( .A(n364), .ZN(n467) );
  NOR2_X1 U362 ( .A1(n466), .A2(n465), .ZN(n349) );
  NOR2_X1 U363 ( .A1(n467), .A2(n349), .ZN(DP_OP_70J31_122_5612_n4) );
  NAND2_X1 U364 ( .A1(DP_OP_70J31_122_5612_n4), .A2(DP_OP_70J31_122_5612_n17), 
        .ZN(n525) );
  OAI21_X1 U365 ( .B1(DP_OP_70J31_122_5612_n17), .B2(DP_OP_70J31_122_5612_n4), 
        .A(n525), .ZN(n350) );
  ...
  INV_X1 U388 ( .A(n526), .ZN(DP_OP_70J31_122_5612_n18) );
  ...
  INV_X1 U456 ( .A(n540), .ZN(DP_OP_71J31_123_5612_n17) );
  OR2_X1 U457 ( .A1(n422), .A2(n421), .ZN(n559) );
  NAND2_X1 U458 ( .A1(n559), .A2(n563), .ZN(n541) );
  INV_X1 U459 ( .A(n541), .ZN(DP_OP_71J31_123_5612_n4) );
  NAND2_X1 U460 ( .A1(DP_OP_71J31_123_5612_n4), .A2(DP_OP_71J31_123_5612_n17), 
        .ZN(n543) );
  OAI21_X1 U461 ( .B1(DP_OP_71J31_123_5612_n17), .B2(DP_OP_71J31_123_5612_n4), 
        .A(n543), .ZN(n423) );
  ...
  INV_X1 U480 ( .A(n544), .ZN(DP_OP_71J31_123_5612_n18) );
  ...
  NAND2_X1 U537 ( .A1(n514), .A2(n513), .ZN(DP_OP_72J31_124_9845_n18) );
  AOI21_X1 U538 ( .B1(n510), .B2(n507), .A(n506), .ZN(n508) );
  XOR2_X1 U539 ( .A(n509), .B(n508), .Z(DP_OP_72J31_124_9845_n16) );
  AOI21_X1 U540 ( .B1(n512), .B2(n511), .A(n510), .ZN(DP_OP_72J31_124_9845_n4)
         );
  XOR2_X1 U541 ( .A(n514), .B(n513), .Z(DP_OP_72J31_124_9845_n17) );
  NAND3_X1 U542 ( .A1(DP_OP_72J31_124_9845_n16), .A2(DP_OP_72J31_124_9845_n4), 
        .A3(DP_OP_72J31_124_9845_n17), .ZN(n515) );
  AND2_X1 U543 ( .A1(DP_OP_72J31_124_9845_n18), .A2(n515), .ZN(
        mul_final_add_sum_gen_carry_select_int_3_S1[3]) );
  INV_X1 U544 ( .A(DP_OP_72J31_124_9845_n16), .ZN(n547) );
  INV_X1 U545 ( .A(DP_OP_72J31_124_9845_n4), .ZN(n546) );
  NOR2_X1 U546 ( .A1(n547), .A2(n546), .ZN(n545) );
  OAI21_X1 U547 ( .B1(n545), .B2(DP_OP_72J31_124_9845_n17), .A(n515), .ZN(n516) );
  ...
  XNOR2_X1 U551 ( .A(n523), .B(n522), .ZN(DP_OP_70J31_122_5612_n19) );
  AND3_X1 U552 ( .A1(DP_OP_70J31_122_5612_n4), .A2(DP_OP_70J31_122_5612_n17), 
        .A3(DP_OP_70J31_122_5612_n18), .ZN(n524) );
  XOR2_X1 U553 ( .A(n524), .B(DP_OP_70J31_122_5612_n19), .Z(
  ...
  XNOR2_X1 U562 ( .A(n570), .B(n539), .ZN(DP_OP_71J31_123_5612_n19) );
  NOR3_X1 U563 ( .A1(n541), .A2(n540), .A3(n544), .ZN(n542) );
  XOR2_X1 U564 ( .A(n542), .B(DP_OP_71J31_123_5612_n19), .Z(
