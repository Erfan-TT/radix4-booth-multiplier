...
module boothmul_registered ( CLK, LD, RST, A, B, P );
  ...
  wire   mul_final_add_sum_gen_carry_select_int_1_S1_0_, n153, n193, n194,
         ...
         DP_OP_72J6_124_5612_n19, DP_OP_72J6_124_5612_n18,
         DP_OP_72J6_124_5612_n17, DP_OP_72J6_124_5612_n4,
         DP_OP_71J6_123_5612_n19, DP_OP_71J6_123_5612_n18,
         DP_OP_71J6_123_5612_n17, DP_OP_71J6_123_5612_n4, n358, n359, n360,
  ...
  NOR2_X1 U437 ( .A1(n432), .A2(n398), .ZN(DP_OP_71J6_123_5612_n4) );
  ...
  OAI21_X1 U483 ( .B1(n436), .B2(n546), .A(n435), .ZN(DP_OP_71J6_123_5612_n18)
         );
  XNOR2_X1 U484 ( .A(n626), .B(n437), .ZN(n552) );
  INV_X1 U485 ( .A(n552), .ZN(DP_OP_71J6_123_5612_n17) );
  INV_X1 U486 ( .A(DP_OP_71J6_123_5612_n4), .ZN(n551) );
  NOR2_X1 U487 ( .A1(n552), .A2(n551), .ZN(n550) );
  NAND3_X1 U488 ( .A1(DP_OP_71J6_123_5612_n17), .A2(DP_OP_71J6_123_5612_n4), 
        .A3(DP_OP_71J6_123_5612_n18), .ZN(n549) );
  OAI21_X1 U489 ( .B1(n550), .B2(DP_OP_71J6_123_5612_n18), .A(n549), .ZN(n438)
         );
  ...
  AOI21_X1 U539 ( .B1(n485), .B2(n498), .A(n516), .ZN(DP_OP_72J6_124_5612_n17)
         );
  NAND2_X1 U540 ( .A1(n544), .A2(n545), .ZN(n486) );
  XOR2_X1 U541 ( .A(n487), .B(n486), .Z(n555) );
  INV_X1 U542 ( .A(n555), .ZN(DP_OP_72J6_124_5612_n4) );
  ...
  XNOR2_X1 U558 ( .A(n511), .B(n510), .ZN(DP_OP_72J6_124_5612_n19) );
  XOR2_X1 U559 ( .A(n513), .B(n512), .Z(n514) );
  XNOR2_X1 U560 ( .A(n515), .B(n514), .ZN(DP_OP_72J6_124_5612_n18) );
  NOR2_X1 U561 ( .A1(n516), .A2(n555), .ZN(n553) );
  NAND2_X1 U562 ( .A1(n553), .A2(DP_OP_72J6_124_5612_n18), .ZN(n517) );
  AND2_X1 U563 ( .A1(DP_OP_72J6_124_5612_n19), .A2(n517), .ZN(
  ...
  XNOR2_X1 U600 ( .A(n633), .B(n548), .ZN(DP_OP_71J6_123_5612_n19) );
  XNOR2_X1 U601 ( .A(n549), .B(DP_OP_71J6_123_5612_n19), .ZN(
  ...
  XOR2_X1 U603 ( .A(n553), .B(DP_OP_72J6_124_5612_n18), .Z(
        mul_final_add_sum_gen_carry_select_int_3_S1[2]) );
  INV_X1 U604 ( .A(DP_OP_72J6_124_5612_n17), .ZN(n554) );
